...
import static org.firstinspires.ftc.teamcode.pedroPathing.OLDChoose.Alliance.BLUE;
import static org.firstinspires.ftc.teamcode.pedroPathing.OLDChoose.Alliance.RED;
...
@TeleOp(name="One Driver Tele", group="Iterative OpMode")
@Config
public class OneDriverTeleForWaring extends OpMode {
    //choose
    ...
    public void loop() {
        ...
        robot.updateIntakeForOneDriver();
        robot.updateTransferForOneDriver(currentColor, vel, x, y);
