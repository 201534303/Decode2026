...
@TeleOp(name="LockTester", group="Iterative OpMode")
@Config
public class LockTester extends OpMode {
    ...
    private double THISISLOCKPOS1 = 0;
    ...
    public void loop() {
        ...
        drivetrain.setStopper1Pos(THISISLOCKPOS1);
        telemetry.addData("THISISLOCKPOS1", THISISLOCKPOS1);
