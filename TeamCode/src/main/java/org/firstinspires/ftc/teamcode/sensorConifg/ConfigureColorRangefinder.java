...
public class ConfigureColorRangefinder extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        crf.setPin0DigitalMaxDistance(ColorRangefinder.DigitalMode.HSV, 60); // Xmm or closer requirement
        crf.setPin1Digital(ColorRangefinder.DigitalMode.HSV, 0, 255); // green
        crf.setPin1DigitalMaxDistance(ColorRangefinder.DigitalMode.HSV, 60); // Xmm or closer requirement
    }
}
